    ...
    <Grid container spacing={2}>
      ...
      <Grid item size={{xl:6,md:6,sm:12}} >
        <Card sx={{ border: "1px solid #ddd", borderRadius: 2,height:"100%" }}>
          <CardContent>
            <Typography sx={{ color: "red", fontWeight: "bold",fontSize:"16px",cursor:"pointer" }} >
      ...
      <Grid item size={{xl:6,md:6,sm:12}} >
        <Card sx={{ border: "1px solid #ddd", borderRadius: 2,height:"100%" }}>
          <CardContent>
            <Typography  sx={{ color: "green", fontWeight: "bold" ,fontSize:"16px",cursor:"pointer"}} onClick={handleOpen}>
